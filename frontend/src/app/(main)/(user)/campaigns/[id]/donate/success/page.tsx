    ...
    return (
      ...
      >
        <div className="max-w-md w-full text-center">
          ...
          <h2
            className="text-[22px] font-bold text-setu-950 mb-2"
            style={{ fontFamily: "var(--font-display)" }}
          >
            Payment Verification Failed
          </h2>
          <p className="text-[14px] text-gray-500 mb-6 leading-relaxed">
            We couldn't verify your payment. If money was deducted from your
            account, it will be refunded within 3–5 business days.
          </p>
          <div className="flex flex-col gap-3">
            <Link
              href={`/campaigns/${id}/donate`}
              className="flex items-center justify-center gap-2 py-4 bg-setu-700 hover:bg-setu-600 text-white font-bold rounded-xl text-sm no-underline transition-all"
            >
              Try Again
            </Link>
            <Link
    ...
    >
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-[14px] text-gray-500 leading-relaxed mb-6 max-w-sm mx-auto">
          ...
          has been confirmed and credited to the campaign.
        </p>
        ...
        <div className="bg-white rounded-2xl border border-setu-100 p-5 mb-6 text-left space-y-3 shadow-sm">
          {[
            ...
            {
              label: "Total paid",
              value: fmtNPR(payment.totalAmount),
              bold: true,
            },
            {
